...
import com.yukiny.sleeplessmod.debug.MagicCommand;
...
import com.yukiny.sleeplessmod.render.EffectGuiRender;
...
public class SpEvents {
    public static void register(){
        ...
        MinecraftForge.EVENT_BUS.register(new EffectGuiRender());
    }
}
